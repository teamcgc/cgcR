...
(https://raw.githubusercontent.com/tengfei/sevenbridges/master/vignettes/bioc-workflow.Rmd) of this page, so you can load it to your Rstudio or your favorite R IDE to run through all examples and tweak setup.
