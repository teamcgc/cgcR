...
app.rnawfbam <- a$copyApp(id =  "Durga/rworkshop2/rna-seq-alignment-star-baseline-20160217", project = pid, name = "star-wfl-inbam")
...
tsk3 = p$task_add(name = "rwflinbamtest", 
           description = "Testing the RNA-seq STAR workflow with input BAM file", 
           app = rwbid,
           inputs =  list(#input_bam = bam.in, 
                          genomeFastaFiles = fasta.in,
                          sjdbGTFfile = gtf.in1))


## p$task_add(name = "rwfltest_tf", 
##             description = "Testing the RNA-seq STAR workflow", 
 ##           app = rwid,
##            inputs =  list(fastq = fastq.in, 
##                          genomeFastaFiles = fasta.in,
